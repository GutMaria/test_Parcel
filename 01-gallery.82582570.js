...
function createGalleryCard(arr) {
  return arr.reduce(function (acc, _ref) {
    ...
    return acc + "<a class=\"gallery__item\" href=\"".concat(original, "\">\n  <img class=\"gallery__image\" src=\"").concat(preview, "\" alt=\"").concat(description, "\" title=\"").concat(description, "\"/>\n</a>");
  }, '');
}
gallery.innerHTML = createGalleryCard(_galleryItems.galleryItems);
