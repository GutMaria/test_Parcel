...
function onFormSubmit(evt) {
  ...
  var submitData = (_submitData = {}, _defineProperty(_submitData, inputEmail.name, inputEmail.value), _defineProperty(_submitData, message.name, message.value), _submitData);
...
function populateForm() {
  var savedInf = JSON.parse(localStorage.getItem('feedback-form-state'));
